    ...
    def run(
        ...
        Args:
            ...
            reserved_ip_ranges (List[str]):
                Optional. A list of names for the reserved ip ranges under the VPC network that can be used for this Pipeline Job's workload.
        ...
        *,
        ...
        Args:
            ...
            reserved_ip_ranges (List[str]):
                ...
                network that can be used for this Pipeline Job's workload. For example: ['vertex-ai-ip-range'].
